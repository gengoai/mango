...
public class CommonTypeConverterTest {
  ...
  public void testCharacter() throws Exception {
    //Convert nulls
    assertEquals(Defaults.defaultValue(char.class), Convert.convert(null, char.class));
    ...
    //Test val version
    assertEquals(Character.valueOf('a'), Val.NULL.asCharacter('a'));
  ...
  public void testString() throws Exception {
    ...
    //Other
    assertEquals("{1=3}", Convert.convert(ImmutableMap.<Integer, Integer>builder().put(1, 3).build(), String.class));
  ...
  public void testStringBuilder() throws Exception {
    ...
    //Other
    assertEquals("{1=3}", Convert.convert(ImmutableMap.<Integer, Integer>builder().put(1, 3).build(), StringBuilder.class).toString());
