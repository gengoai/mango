...
public final class NumberConverter {
   ...
   */
  public static final Function<Object, Double> DOUBLE = object -> {
    if (object == null) {
      return null;
   ...
   */
  public static final Function<Object, Float> FLOAT = object -> {
   ...
   */
  public static final Function<Object, Integer> INTEGER = object -> {
    Number number = DOUBLE.apply(object);
   ...
   */
  public static final Function<Object, Long> LONG = object -> {
    Number number = DOUBLE.apply(object);
   ...
   */
  public static final Function<Object, Short> SHORT = object -> {
    Number number = DOUBLE.apply(object);
   ...
   */
  public static final Function<Object, BigDecimal> BIG_DECIMAL = object -> {
    if (object == null) {
      return null;
    } else if (object instanceof BigDecimal) {
...
//        return new BigDecimal(MathEvaluator.evaluate(object.toString()));
   ...
   */
  public static final Function<Object, BigInteger> BIG_INTEGER = object -> {
    if (object == null) {
      return null;
    } else if (object instanceof BigInteger) {
      return Cast.as(object);
...
//        return new BigInteger(Double.toString(MathEvaluator.evaluate(object.toString())));
   ...
   */
  public static final Function<Object, Boolean> BOOLEAN = input -> {
    if (input == null) {
      return null;
   ...
   */
  public static final Function<Object, Byte> BYTE = object -> {
    if (object == null) {
      return null;
