...
package com.gengoai.mango.logging;
 ...
 * <code>com.gengoai.mango.logging.dir</code> and default to <code>%HOME/logs/</code>. The file handler will produce up
...
public final class LogManager {
   ...
   /**
    * Adds a file handler that writes to the location specified in <code>com.gengoai.mango.logging.dir</code> or if not
   ...
   public synchronized static void addFileHandler(String basename) throws IOException {
      String dir = Config.get("com.gengoai.mango.logging.dir").asString(SystemInfo.USER_HOME + "/logs/");
