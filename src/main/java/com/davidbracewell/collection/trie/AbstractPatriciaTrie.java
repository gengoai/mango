 ...
 * is related to the {@link java.util.Map} interface.
 *
 * @since 4.0
...
abstract class AbstractPatriciaTrie<K, V> extends AbstractBitwiseTrie<K, V> {
     ...
     * It's used to detect concurrent modifications and fail-fast the {@link java.util.Iterator}s.
     */
    ...
    /**
     * Constructs a new {@link Trie} using the given
     * {@link KeyAnalyzer} and initializes the {@link  Trie}
     * with the values from the provided {@link java.util.Map}.
     */
    protected AbstractPatriciaTrie(final KeyAnalyzer<? super K> keyAnalyzer,
     ...
     * {@link java.util.Iterator}. The {@link java.util.SortedMap#firstKey()},
     * {@link java.util.SortedMap#lastKey()} &amp; {@link java.util.Map#size()} methods must
     ...
     * All other methods (except {@link java.util.Iterator}) must compare the given
     * key to the prefix to ensure that it is within the range of the view.
     * The {@link java.util.Iterator}'s remove method must also relocate the subtree
     ...
     * @return a {@link java.util.SortedMap} view of this {@link Trie} with all elements whose
    ...
    /**
     * This is a entry set view of the {@link Trie} as returned by {@link java.util.Map#entrySet()}.
     */
    private class EntrySet extends AbstractSet<Entry<K,V>> {
        ...
        /**
         * An {@link java.util.Iterator} that returns {@link Entry} Objects.
         */
    ...
    /**
     * This is a key set view of the {@link Trie} as returned by {@link java.util.Map#keySet()}.
     */
    private class KeySet extends AbstractSet<K> {
        ...
        /**
         * An {@link java.util.Iterator} that returns Key Objects.
         */
    ...
    /**
     * This is a value view of the {@link Trie} as returned by {@link java.util.Map#values()}.
     */
    private class Values extends AbstractCollection<V> {
        ...
        /**
         * An {@link java.util.Iterator} that returns Value Objects.
         */
    ...
    abstract class TrieIterator<E> implements Iterator<E> {
        ...
        /**
         * Returns the next {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.TrieEntry}.
         */
        ...
        /**
         * @see PatriciaTrie#nextEntry(iknowledge.espresso.collections.trie.AbstractPatriciaTrie.TrieEntry)
         */
    ...
    private abstract class RangeMap extends AbstractMap<K, V>
        ...
        /**
         * Creates and returns an {@link #entrySet()} view of the {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeMap}.
         */
        ...
        /**
         * Returns true if the provided key is in the FROM range of the {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeMap}.
         */
        ...
        /**
         * Returns true if the provided key is in the TO range of the {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeMap}.
         */
        ...
        /**
         * Creates and returns a sub-range view of the current {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeMap}.
         */
   ...
   /**
    * A {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeMap} that deals with {@link java.util.Map.Entry}s.
    */
   private class RangeEntryMap extends RangeMap {
       ...
       /**
        * Creates a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeEntryMap} with the fromKey included and
       ...
       /**
        * Creates a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeEntryMap}.
        */
    ...
    /**
     * A {@link java.util.Set} view of a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeMap}.
     */
    private class RangeEntrySet extends AbstractSet<Entry<K, V>> {
        ...
        /**
         * Creates a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeEntrySet}.
         */
        ...
        /**
         * An {@link java.util.Iterator} for {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeEntrySet}s.
         */
        private final class EntryIterator extends TrieIterator<Entry<K,V>> {
            ...
            /**
             * Creates a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeEntrySet.EntryIterator}.
             */
    ...
    private class PrefixRangeMap extends RangeMap {
        ...
        /**
         * Creates a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.PrefixRangeMap}.
         */
         ...
         * and TO range of the {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.PrefixRangeMap} and the number
        ...
        /**
         * Returns true if this {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.PrefixRangeMap}'s key is a prefix of the provided key.
         */
        @Override
        protected boolean inRange(final K key) {
        ...
        /**
         * Returns true if the provided Key is in the FROM range of the {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.PrefixRangeMap}.
         */
        @Override
        protected boolean inFromRange(final K key, final boolean forceInclusive) {
            return getKeyAnalyzer().isPrefix(prefix, offsetInBits, lengthInBits, key);
        ...
        /**
         * Returns true if the provided Key is in the TO range of the {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.PrefixRangeMap}.
         */
        @Override
        protected boolean inToRange(final K key, final boolean forceInclusive) {
            return getKeyAnalyzer().isPrefix(prefix, offsetInBits, lengthInBits, key);
    ...
    /**
     * A prefix {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.RangeEntrySet} view of the {@link Trie}.
     */
    private final class PrefixRangeEntrySet extends RangeEntrySet {
        ...
        /**
         * Creates a {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.PrefixRangeEntrySet}.
         */
        ...
        /**
         * An {@link java.util.Iterator} that holds a single {@link iknowledge.espresso.collections.trie.AbstractPatriciaTrie.TrieEntry}.
         */
        ...
        /**
         * An {@link java.util.Iterator} for iterating over a prefix search.
         */
        private final class EntryIterator extends TrieIterator<Entry<K, V>> {
