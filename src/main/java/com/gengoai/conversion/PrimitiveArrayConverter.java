   ...
   public static final Function<Object, byte[]> BYTE = new Function<Object, byte[]>() {
      ...
      public byte[] apply(Object o) {
         ...
         if (o instanceof byte[]) {
            ...
            return Primitives.toByteArray(Arrays.asList((Byte[]) o));
            ...
            try (InputStream inputStream = IOConverter.INPUT_STREAM.apply(o)) {
               ...
               return Resources.fromInputStream(inputStream).readBytes();
            } catch (IOException e) {
            ...
            try{
               return Resources.fromReader(Cast.as(o)).readToString().getBytes();
            } catch (IOException e) {
               log.fine(e);
               return null;
            }
   ...
   public static final Function<Object, char[]> CHAR = new Function<Object, char[]>() {
      ...
      public char[] apply(Object o) {
         ...
         if (o instanceof char[]) {
            ...
            return Primitives.toCharArray(Arrays.asList(Cast.<Character[]>as(o)));
         } else if (o instanceof CharSequence) {
            ...
            try (Reader reader = IOConverter.READER.apply(o)) {
               ...
               return Resources.fromReader(reader).readToString().toCharArray();
            } catch (IOException e) {
               log.fine("Error reading in {0}: {1}", o, e);
               return null;
            }
