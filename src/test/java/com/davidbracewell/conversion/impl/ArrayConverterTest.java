...
import com.davidbracewell.conversion.ArrayConverter;
...
public class ArrayConverterTest {
  ...
  public void applyTest() throws Exception {
    assertArrayEquals(new Integer[]{1, 3, 4}, new ArrayConverter<>(Integer.class).apply(new Object[]{"1", 3.0, 4}));
    ...
    //Test null in output
    assertArrayEquals(new Integer[]{null, 3, 4}, new ArrayConverter<>(Integer.class).apply(new Object[]{"ABCD", 3.0, 4}));
    ...
    assertArrayEquals(new String[]{"{1=3}", "12.3"}, Val.of(new Object[]{
        ImmutableMap.<Integer, Integer>builder().put(1, 3).build(),
        12.3
    }).asStringArray());
  }
  ...
  public void testByte() throws Exception {
    ...
    assertArrayEquals(new Byte[]{'a', 'b', 'c'}, new ArrayConverter<>(Byte.class).apply(new Character[]{'a', 'b', 'c'}));
    assertArrayEquals(new Byte[]{'a', 'b', 'c'}, new ArrayConverter<>(Byte.class).apply(new Object[]{"a", "b", 'c'}));
  ...
  public void testChar() throws Exception {
    ...
    int b = 'b';
    int c = 'c';
    assertArrayEquals(new Character[]{'a', 'b', 'c'}, new ArrayConverter<>(Character.class).apply(new Object[]{a, b, c}));
    assertArrayEquals(new Character[]{'a', 'b', 'c'}, new ArrayConverter<>(Character.class).apply(new Character[]{'a', 'b', 'c'}));
    assertArrayEquals(new Character[]{'a', 'b', 'c'}, new ArrayConverter<>(Character.class).apply(new Object[]{"a", "b", 'c'}));
