...
public final class Sets {
   ...
   */
  public static <E> void addIf(boolean condition, @NonNull Set<E> set, @NonNull E value) {
    if (condition) {
      set.add(value);
    }
  }
  ...
  public static <E> Set<E> intersection(Set<? extends E> s1, Set<? extends E> s2) {
    return Cast.as(Collect.intersection(bestSupplier(s1, s2), s1, s2));
  }
  ...
  private static <E> Supplier<Set<E>> bestSupplier(Set<?> set1, Set<?> set2) {
    if (set1 == null && set2 == null) {
      ...
      return () -> Cast.as(Collect.create(set2.getClass()));
    }
    return () -> Cast.as(Collect.create(set1.getClass()));
  }
