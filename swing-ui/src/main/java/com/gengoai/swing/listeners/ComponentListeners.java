...
public final class ComponentListeners {
   ...
   public static <T extends JComponent> T componentResized(@NonNull T component,
                                                           @NonNull Consumer<ComponentEvent> eventHandler) {
      component.addComponentListener(componentResized(eventHandler));
      return component;
   }
