  ...
  public com.davidbracewell.parsing.ParserToken next() throws java.io.IOException, com.davidbracewell.parsing.ParseException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 1: {
          yybegin(stack.pop());
          return new ParserToken(yytext(), ConfigTokenType.VALUE);
        }
        case 19:
          break;
        case 2: {
        ...
        case 5: {
          yybegin(stack.pop());
          return new ParserToken(yytext(), ConfigTokenType.END_SECTION);
        }
        case 23:
          break;
        case 6: {
        ...
        }
        {
          stack.push(YYINITIAL);
          yybegin(START_VALUE);
          return new ParserToken(yytext(), ConfigTokenType.PROPERTY);
        }
        case 29:
          break;
        case 12:
        ...
        {
          stack.push(YYINITIAL);
          yybegin(START_SECTION);
          return new ParserToken(yytext(), ConfigTokenType.SECTION_HEADER);
        }
        case 30:
          break;
        case 13:
        ...
        case 17: {
          yybegin(IMPORT);
          return new ParserToken(yytext(), ConfigTokenType.IMPORT);
        }
        case 35:
          break;
        case 18: {
          yybegin(SCRIPT);
          return new ParserToken(yytext(), ConfigTokenType.SCRIPT);
        }
        case 36:
          break;
        default:
