...
public class NTupleTest {
  ...
  public void mapValues() throws Exception {
    Assert.assertEquals(Tuples.$("a", "a", "a", "a"), tuple.mapValues(o -> o.toString().toLowerCase()));
  }

  @Test
  public void shiftLeft() throws Exception {
    Assert.assertEquals(Tuples.$("A", "A", "A"), tuple.shiftLeft());
  }

  @Test
  public void shiftRight() throws Exception {
    Assert.assertEquals(Tuples.$("A", "A", "A"), tuple.shiftRight());
  }

  @Test
  public void appendRight() throws Exception {
    Assert.assertEquals(Tuples.$("A", "A", "A", "A", "A"), tuple.appendRight("A"));
  }

  @Test
  public void appendLeft() throws Exception {
    Assert.assertEquals(Tuples.$("A", "A", "A", "A", "A"), tuple.appendLeft("A"));
  }
