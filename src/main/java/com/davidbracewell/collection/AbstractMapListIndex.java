 ...
 */
public abstract class AbstractMapListIndex<TYPE> implements Index<TYPE>, Serializable {


  private static final long serialVersionUID = -288128807385573349L;

  protected abstract Map<TYPE, Integer> map();

  protected abstract List<TYPE> list();
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AbstractMapListIndex) {
      return list().equals(((AbstractMapListIndex<?>) o).list());
    }
    return false;
  }
