...
public class Tuple3Test {
  ...
  public void mapValues() throws Exception {
    assertEquals($("a", "a", "a"), tuple.mapValues(o -> o.toString().toLowerCase()));
  }

  @Test
  public void shiftLeft() throws Exception {
    assertEquals($("A", "A"), tuple.shiftLeft());
  }

  @Test
  public void shiftRight() throws Exception {
    assertEquals($("A", "A"), tuple.shiftRight());
  }

  @Test
  public void appendRight() throws Exception {
    assertEquals($("A", "A", "A", "A"), tuple.appendRight("A"));
  }

  @Test
  public void appendLeft() throws Exception {
    assertEquals($("A", "A", "A", "A"), tuple.appendLeft("A"));
  }
  ...
  public void list() throws Exception {
    assertTrue($(Arrays.asList("A", "A", "A")) instanceof Tuple3);
  }
