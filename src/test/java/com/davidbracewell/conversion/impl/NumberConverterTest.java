...
import com.davidbracewell.conversion.NumberConverter;
...
public class NumberConverterTest {
  ...
  public void bigIntegerTests() throws Exception {
    ...
    //Test casts
    assertEquals(BigInteger.ONE, Convert.convert(new BigInteger("1"), BigInteger.class));
    ...
    //Test fail
    assertNull(Convert.convert(Maps.newHashMap(), BigInteger.class));
  }
  ...
  public void integerTests() throws Exception {
    ...
    //Test fail
    assertEquals(new Integer(0), Convert.convert(Lists.newArrayList(), int.class));
    assertNull(Convert.convert(Maps.newHashMap(), Integer.class));

    //Val test
    assertEquals(new Integer(1), Val.of("1.2").asInteger());
  ...
  public void doubleTests() throws Exception {
    ...
    //Test fail
    assertEquals(0d, Convert.convert(Lists.newArrayList(), double.class), 0d);
    assertNull(Convert.convert(Maps.newHashMap(), Double.class));
  ...
  public void floatTests() throws Exception {
    ...
    //Test fail
    assertEquals(0f, Convert.convert(Lists.newArrayList(), float.class), 0f);
    assertNull(Convert.convert(Maps.newHashMap(), Float.class));
  ...
  public void longTests() throws Exception {
    ...
    //Test fail
    assertEquals(0L, (long) Convert.convert(Lists.newArrayList(), long.class));
    assertNull(Convert.convert(Maps.newHashMap(), Long.class));
  ...
  public void shortTests() throws Exception {
    ...
    //Test fail
    assertEquals(0, (short) Convert.convert(Lists.newArrayList(), short.class));
    assertNull(Convert.convert(Maps.newHashMap(), Short.class));
  ...
  public void byteTests() throws Exception {
    ...
    //Test fail
    assertEquals(0, (byte) Convert.convert(Lists.newArrayList(), byte.class));
    assertNull(Convert.convert(Maps.newHashMap(), Byte.class));
  ...
  public void booleanTests() throws Exception {
    ...
    //Test fail
    assertEquals(false, Convert.convert(Lists.newArrayList(), boolean.class));
    assertNull(Convert.convert(Maps.newHashMap(), Boolean.class));
