...
public class Tuple1Test {
  ...
  public void mapValues() throws Exception {
    Assert.assertEquals(Tuples.$("a"), tuple.mapValues(o -> o.toString().toLowerCase()));
  }

  @Test
  public void shiftLeft() throws Exception {
    Assert.assertEquals(Tuples.$(), tuple.shiftLeft());
  }

  @Test
  public void shiftRight() throws Exception {
    Assert.assertEquals(Tuples.$(), tuple.shiftRight());
  }

  @Test
  public void appendRight() throws Exception {
    Assert.assertEquals(Tuples.$("A", "A"), tuple.appendRight("A"));
  }

  @Test
  public void appendLeft() throws Exception {
    Assert.assertEquals(Tuples.$("A", "A"), tuple.appendLeft("A"));
  }
