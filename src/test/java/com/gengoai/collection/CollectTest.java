...
public class CollectTest {
   ...
   public void iteratorToIterable() throws Exception {
      Iterable<CharSequence> ibl1 = Collect.asIterable(Lists.list("A", "B", "C").iterator());
   ...
   public void sort() throws Exception {
      Assert.assertEquals(Lists.list("a", "b", "c"), Collect.sort(Sets.set("c", "b", "a")));
      Assert.assertEquals(Lists.list(3, 2, 1), Collect.sort(Lists.list(1, 2, 3), Sorting.natural().reversed()));
   }


   @Test
   public void arrayAsIterable() throws Exception {
      Assert.assertEquals(Lists.list(1, 2, 3), Lists.asArrayList(Collect.asIterable(new int[]{1, 2, 3}, Integer.class)));
      Assert.assertEquals(Lists.list(1, 2, 3), Lists.asArrayList(Collect.asIterable(new Integer[]{1, 2, 3}, Integer.class)));
      Assert.assertEquals(Lists.list(1, 2, 3), Lists.asArrayList(Collect.asIterable(new double[]{1.0, 2.0, 3.0}, Integer.class)));
   }
