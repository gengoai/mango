...
public class CharsetDetectingReaderTest {
  ...
  public void testUTF16_LE() throws Exception {
    assertEquals("안녕하세요", read("/com/davidbracewell/io/UTF16_LE.txt"));
  }


  @Test
  public void testUTF16_BE() throws Exception {
    assertEquals("안녕하세요", read("/com/davidbracewell/io/UTF16_BE.txt"));
  }

  @Test
  public void testUTF8() throws Exception {
    assertEquals("안녕하세요", read("/com/davidbracewell/io/UTF8.txt"));
  }

  @Test
  public void testAutoDetect() throws Exception {
    assertEquals("今日は、僕の名前はデービットです。", read("/com/davidbracewell/io/SHIFT_JIS.txt"));
  }
